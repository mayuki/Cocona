...
{
    public class ZshCoconaShellCompletionCodeProvider : ICoconaShellCompletionCodeProvider
    {
        ...
        public ZshCoconaShellCompletionCodeProvider(
        ...
        public void Generate(TextWriter writer, CommandCollection commandCollection)
        {
            ...
            writer.WriteLine($"# ");
            writer.WriteLine($"# Generated by Cocona {nameof(ZshCoconaShellCompletionCodeProvider)}");
            writer.WriteLine($"# ");
            writer.WriteLine();
